...
window.lessonsList = {
  ...
  'advanced': [
    { id: '301', title: 'Cooperative Sovereignty', description: 'تحليل مفهوم السيادة المشتركة' },
    { id: '302', title: 'Decoupling Future', description: 'مستقبل العولمة وفك الارتباط' },
    { id: '303', title: 'Modern Conflict', description: 'حروب الجيل الخامس والمعلومات' },
    { id: '304', title: 'Sovereignty Paradox', description: 'تناقض السيادة في الحوكمة العالمية' }
  ]
};
